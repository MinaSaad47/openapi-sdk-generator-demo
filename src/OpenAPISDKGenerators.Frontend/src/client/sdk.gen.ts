...
import type { CreateProductData, CreateProductResponses, GetProductsData, GetProductsResponses, GetUsersData, GetUsersResponses } from './types.gen';
...
export const createProduct = <ThrowOnError extends boolean = false>(options: Options<CreateProductData, ThrowOnError>) => {
    return (options.client ?? client).post<CreateProductResponses, unknown, ThrowOnError>({
        responseType: 'json',
        url: '/products',
        ...options,
        headers: {
